...
import com.fsb.tunicasa_api.business.services.JwtService;
@Service
public class JwtServiceImpl implements JwtService {

    // Encodes JWT tokens
    private final JwtEncoder encoder;
    // Specifies the expiration time for the JWT token in seconds, fetched from application properties 
    @Value("${jwt.expiration}")
    private long jwtExpiration;
    // Specifies the name of the cookie that will store the JWT token, fetched fromapplication properties 
